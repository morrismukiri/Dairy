...
if (isset($_GET['e_payroll_no'])) {
    ...
    if (isset($_POST['submitted'])) {
        ...
        $sql = "UPDATE `employees` SET  `e_name` =  '{$_POST['e_name']}' ,  `e_mail` =  '{$_POST['e_mail']}' ,  `e_pass` =  '{$_POST['e_pass']}' ,  `e_role` =  '{$_POST['e_role']}' ,  `e_payroll_no` =  '{$_POST['e_payroll_no']}'   WHERE `e_payroll_no` = '$e_payroll_no' ";
